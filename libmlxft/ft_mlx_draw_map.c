...
/*   Updated: 2014/11/29 19:01:10 by glafitte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libmlxft.h"

int	ft_mlx_draw_map(t_mlxenv *e, int x_size, int y_size, int square)
{
	t_mlxp	p1;
	//int		x;
	//int		y;

	x_size = WIN_X / 200 * x_size;
	y_size = WIN_Y / 200 * y_size;
